...
void generateTimeSlotsUpdate(context, list, UpdateSpecialistHoraryPageController insertSpecialistHoraryPageController) {
...
void hihiUpdate(context,list,UpdateSpecialistHoraryPageController insertSpecialistHoraryPageController) {
  showDialog(
    context: context,
    useSafeArea: true,
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () { generateTimeSlotsUpdate(context,list, insertSpecialistHoraryPageController);},
            child: const Text(
              'Continuar',
              style: TextStyle(color: Color.fromARGB(255, 255, 255, 255)),
            ),
